...
export const t: Dict = {
  ...
  symptoms: { ne: "लक्षण", en: "Symptoms" },
  healthAwareness: { ne: "स्वास्थ्य जागरुकता", en: "Health Awareness" },
  symptomsIntro: {
    ne: "तुरुन्त ध्यान दिनु पर्ने सामान्य लक्षण र खतरा संकेतहरू हेर्नुहोस्।",
    en: "See common symptoms and warning signs to watch for.",
  },
  viewAllDangerSigns: {
    ne: "सबै खतरनाक लक्षणहरू हेर्नुहोस्",
    en: "View all danger signs",
  },
  healthAwarenessIntro: {
    ne: "रक्त दान, सहयोग र स्वास्थ्य सहायता अनुरोधहरू साझा गर्नुहोस्।",
    en: "Share blood requests, charity needs, and health support.",
  },
  requestTypeLabel: { ne: "अनुरोध प्रकार", en: "Request type" },
  requestTypeBlood: { ne: "रक्तको लागि अनुरोध", en: "Blood request" },
  requestTypeCharity: { ne: "दान / सहयोग अनुरोध", en: "Charity request" },
  requestTitleLabel: { ne: "शीर्षक", en: "Title" },
  requestDetailsLabel: { ne: "विवरण", en: "Details" },
  uploadProof: { ne: "बिल प्रमाण अपलोड गर्नुहोस्", en: "Upload bill proof" },
  submitRequest: { ne: "अनुरोध पोस्ट गर्नुहोस्", en: "Post request" },
  noRequests: { ne: "अहिले कुनै अनुरोधहरू छैनन्।", en: "No requests yet." },
  requestPostedBy: { ne: "पोस्ट गर्ने", en: "Posted by" },
  requestContact: { ne: "सम्पर्क नम्बर", en: "Contact" },
  communityPosts: { ne: "समुदायका अनुरोधहरू", en: "Community requests" },
  communityPostsIntro: {
    ne: "यहाँ साझा गरेको डोनर र सहयोग अनुरोधहरू सबैले देख्न सक्छन्।",
    en: "Shared blood and charity requests are visible to the community.",
  },
  fillFields: {
    ne: "कृपया शीर्षक र विवरण भर्नुहोस्।",
    en: "Please fill in a title and details.",
  },
  contactRequired: {
    ne: "रक्त अनुरोधका लागि सम्पर्क नम्बर आवश्यक छ।",
    en: "Contact number is required for blood requests.",
  },
  requestPosted: { ne: "तपाईंको अनुरोध पोस्ट गरियो।", en: "Your request has been posted." },
  ...
  uploadProfileData: { ne: "पाठ्य जानकारी अपलोड गर्नुहोस्", en: "Upload health data" },
  uploadButton: { ne: "अपलोड गर्नुहोस्", en: "Upload" },
  noFileSelected: { ne: "कुनै फाइल चयन गरिएको छैन", en: "No file selected" },
  uploadedFile: { ne: "अपलोड गरिएको फाइल:", en: "Uploaded file:" },
  darkMode: { ne: "अँध्यारो", en: "Dark" },
  lightMode: { ne: "प्रकाश", en: "Light" },
  removeFile: { ne: "फाइल हटाउनुहोस्", en: "Remove file" },
